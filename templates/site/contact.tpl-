      ...
      <section class="content my_team">
        ...
        <section class="content_sec_1 pad_none">
          <div class="max-width-900">
            ...
            <p class="paragraph-text">Broederminstraat 7, 2018 Antwerpen<br>+32 (0) 3 773 52 00 - <span class="strong"><a id="info_be" class="info_be black-underlined" href="mailto:"></a></span><br><br><br></p>
            ...
            <p class="paragraph-text">{$taalContent['contact']['text_block']['p_4']}<span class="strong"><a href="/{$taal}/register/0" class="black-underlined" target="_blank">inschrijven.castingteam.com</a></span></p>
          </div>
        </section>
        <!-- End Content -->
      </section>
