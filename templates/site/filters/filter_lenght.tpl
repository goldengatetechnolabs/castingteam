 <li class='m-result shadow-effect content-focus {if $filters['lenght']['active'] eq true} active{/if}' id='lenght'>
     <header>
         <h5 data-collapse='m-collapse' data-target='#content-13' ><span class="icon"></span>{$taalContent['filters']['length']}</h5>
     </header>
     <div class='m-collapse' id='content-13' style="display: {if $filters['lenght']['active'] eq true} block{else}none{/if};">
