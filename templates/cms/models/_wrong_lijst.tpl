...
var isLoadedPreveously = true;MODELLENBESTAND
        ...
        success:function(json) {
            if (!json.error) {
                ...
                if (lastResultCount > 0) {
                    ...
                    $("#result_count").text(lastResultCount + ' results found');
                }
            } else {
...
{if isset($is_selection) && $is_selection == 1}
 <div class="selection_block">
     <div class="selection-wrapper">
         <h2 class="selection_group_header">Own selections</h2>
     ...
     <div class="selection-wrapper">
         <h2 class="selection_group_header">Client selections</h2>
         <div class="selection_content">
             <section class="cast_team_cont_sel" id="selections">
        ...
        <div id="filters">
            ...
            <label class="label">
                <select class="filter" name='addfilter' >
                    ...
                    <option value="leeftijd">Age</option>
                    <option>---------</option>
                    <option value="huidskleur">Skin color</option>
                    <option value="haarlengte">Hair length</option>
                    <option value="haarstijl">Haar style</option>
                    <option value="haarkleur">Haar color</option>
...
<div class="popup selection" id="save-selection">
    <a href="#" class="close"><span class="icon-cross icon"></span></a>
...
<div class="popup selection" id="save-single-selection">
    <a href="#" class="close"><span class="icon-cross icon"></span></a>
    <h3>Bewaar deze selectie</h3>
    <p class="intro">Voeg deze nieuwe selectie toe aan een bestaande selectie</p>
