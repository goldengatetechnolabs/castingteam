...
<style type="text/css">
    ...
    a.button:hover {background-color: #303030;}
...
<h1 class="h1_custom">{$model.voornaam} {$model.naam} ({$model.age}) -  {$model.model_id}  <span class="copy-iconf" id="copyText" onclick="tempCopy('{$model.model_id} {$model.voornaam}')"><i class="fas fa-copy"></i></span><a href="/nl/alle-modellen-en-people/{$model.model_id}" target="_blank" class="copy-iconf"><i class="fas fa-user"></i></a></h1>


{if $admin.typeName!='updater'}{if isset($previousModel)}<div style="float:left; font-size: 46px; margin-right: 40px; margin-bottom: 20px;"><a href="{if $pageType eq 'single_page'}/cms/models/models/aanpassen/?id={$previousModel}{else}javascript:getModelTemplate({$previousModel}){/if}"><i class="fa fa-arrow-left fa-3"></i></a></div>

{/if}{if isset($nextModel)}<div style="float:right; font-size: 46px; margin-left: 40px; margin-bottom: 20px;"><a href="{if $pageType eq 'single_page'}/cms/models/models/aanpassen/?id={$nextModel}{else}javascript:getModelTemplate({$nextModel}){/if}"><i class="fa fa-arrow-right fa-3"></i></a></div>{/if}{/if}
...
<form method="post" action="/cms/models/models/ajax_aanpassen/" class="ajax" id="formulier">
    ...
    <div id="model-details-input">
        ...
        <div class="model-details-input-kolom">
            ...
            <div class="input">
                ...
                <select name="land" class="custom-select-new" style="width: 228px; color: #000000 !important;">
                    ...
                    <option value="UK"{if $model.land=='UK'} selected="selected"{/if}>UK</option>
                        ...
                        <div class="input">Talentcode - {$model.code}</div>
        ...
        <div class="model-details-input-kolom">
            ...
            <div class="input">
                ...
                <select name="geboortedatum_dag" onchange="veranderGeslacht()" class="custom-select-new" style="width: 60px; color: #000000 !important; margin-right: 5px;">
                ...
                <select name="geboortedatum_maand" onchange="veranderGeslacht()" class="custom-select-new" style="width: 60px; color: #000000 !important; margin-right: 5px;">
                ...
                <select name="geboortedatum_jaar" onchange="veranderGeslacht()" class="custom-select-new" style="width: 82px; color: #000000 !important;">
            ...
            <div class="input">
                ...
                <select name="geslacht" class="custom-select-new" style="width: 212px; color: #000000 !important;" onchange="veranderGeslacht()">
            ...
            <div class="input">
                ...
                <select name="moedertaal" class="custom-select-new" style="width: 212px; color: #000000 !important;">
            ...
            <div class="input">
                ...
                <select name="status" class="custom-select-new niet-verplicht" style="width: 212px; color: #000000 !important;">
            ...
            <div class="input">
                ...
                <select name="country" class="custom-select-new" style="width: 212px; color: #000000 !important;">
    ...
    <div id="model-details-buttons">
        ...
        {if strlen($model.model_id) < 6}
            {if $admin.typeName!='updater'}{if $model.declined !== 2}<a href="javascript:changeModel({$model.model_id},6)" class="button new pdng">Renew</a>{/if}{/if}<br/>
        ...
        {else}
            <a href="/pdf/modelPdf/?id={$model.model_id}" class="button pdf_button new" target="_blank"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> PDF</a><br/>
        {/if}
