{literal} 
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('#cms-subscriptions').on('click', 'tr td #approve_user', function(e) {

                approveUser($(this).parent().parent().attr('id'));
