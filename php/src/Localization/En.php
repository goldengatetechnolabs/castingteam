...
class Localization_En extends Localization_Language
{
    /**
     * @var string[]
     */
    protected $content = [
        ...
        'links' =>
            [
                ...
                'logout' => 'Log out',
                'new_talents' => 'New talent',
                'people_models' => 'Our people',
                'people_models_button' => 'Talent database',
                'carousel_gallery' => 'Pubs with our people',
                'talent_section' => 'About us',
                'vip' => 'Become a VIP',
                'casting' => 'Casting',
                'contact' => 'Contact',
        ...
        'footer' =>
            [
                'link_instagram' => 'Castingteam on Instagram',
                'link_youtube' => 'Commercials and clips on YouTube',
                'link_facebook' => 'Castingteam on Facebook',
        ...
        'homepage' =>
            [
                ...
                'section_about' =>
                    [
                        'title' => 'Castingteam consists of people who like to work with people; our passion lies in searching - and finding - original and characterful personalities.',
                        'text' => '<p><strong>Castingteam is a casting -and modeling agency; the best of both worlds.</strong></p>
                                <p>We are Casting directors - so we are actively looking for the right people for every idea - but at the same time we also have our own database with more than 6,000 talents, and a network of more than 50,000 people.</p>
                                <p>Models, actors and actresses, (noble) fi gurants, young violence or old grunts; fresh new talents and seasoned professionals.</p>'
                    ],
                'button_instagram' => 'To Instagram',
                'section_bordermodels' =>
                    [
                        'text' => 'A separate modeling department has been created from Castingteam; <a target="_blank" href="http://bordermodels.com/">bordermodels.com</a>, specialized in professional and international lifestyle & fashion models.',
                        'button' => 'Discover Bordermodels'
                    ],
                'section_vlambaar' =>
                    [
                        'text' => 'Also arise from Castingteam; <a target="_blank" href="http://vlambaar.com">Vlambaar.com</a>. Vlambaar supplies hostesses and promoters, actors and actresses, presenters and presentators, artists and models, for events and activation campaigns.',
                        'button' => 'Discover Vlambaar'
                    ]
            ],
        'vip' =>
            [
...
These terms and conditions apply to the relationship between the model / actor that is enrolled on this website, and Castingteam or Bordermodels, which are divisions of Borderfield BVBA.<br><br>

Subscription on the website as a model implies a unconditional acceptance of these terms and conditions. If and as long as the model / actor is underage, this consent and acceptance will be confirmed by the legally responsible parent and / or guardian.<br><br>

1. Borderfield BVBA offers the model the opportunity to be included on the Castingteam or Bordermodels website and to receive offers to work as a model or actor for third parties whereby Borderfield BVBA mediates. There is no authority in any way in the relationship between Borderfield BVBA and the model / actor. A relationship such as employer and employee between Borderfield BVBA and the model / actor is explicitly excluded. <br><br>

For the execution of modelling, acting or other assignments, the model / actor enters into a separate contract, either with Borderfield BVBA, a client of Borderfield BVBA, or a payroll office, but without Borderfield BVBA in the role of employer. <br><br>

Borderfield BVBA is not in any way responsible for incidents which could occur during assignments, either on the road, on the set or elsewhere. Borderfield BVBA does not provide a working, incidents -or travel insurance. <br><br>

2. Borderfield BVBA does not require that a model / actor exclusively work for Borderfield BVBA. Conversely, Borderfield BVBA can not be held responsible for representing a model / actor, who has some form of exclusivity contract with a third party. Applying through the website of Castingteam or Bordermodels via the subscription form and agreeing with the Terms and Conditions implies permission to be included in the file on the website, to be published online, to be proposed to clients of Borderfield BVBA, to be contacted (via email, telephone or other) and in any other way to be utilised for publicity of Borderfield BVBA. <br><br>

The model / actor may request Borderfield BVBA to delete his / her profile or change to ‘offline’ status at any time, by directing a simple request to Borderfield BVBA, via email. <br><br>

3. The model / actor confirms to possess all the necessary copyrights to the photos he or she uploads to the website of Castingteam or Bordermodels. The model / actor expressly grants Borderfield BVBA the permission to place and distribute these photos on the internet in any manner and, if required, to make all the adjustments that Borderfield BVBA considers necessary including, but not limited to, the format and editing of the pictures, and the removal of the photographers name or logo. <br><br>

Borderfield BVBA can not be held responsible for any claims in copyright and the model acquits Borderfield BVBA from legal prosecution entirely. <br><br>

4. The data provided by the model / actor will be filed / kept by Borderfield BVBA, solely for the purpose of representing the model / actor. As such, all this data may be passed on to third parties, including Borderfield BVBA clients, such as advertising agencies, photographers and fashion houses, but solely in the execution of the arrangement between Borderfield BVBA and the model / actor. <br><br>

The stored / archived data includes the name, date of birth, gender, address, contact details, native language and various external features, including but not limited to the skin color / complexion. The model / actor explicitly acknowledges the processing of this data. The model / actor has the right to ask Borderfield BVBA for information regarding what specific personal data we have on file, and ask for it to be corrected or removed, free of charge, by contacting Borderfield BVBA through the contact details provided on the websites. <br><br>

5. Remuneration (applicable in Germany or via the German division only): Borderfield BVBA will propose a fee to it’s clients in exchange for a model or actors’ services. On this fee 15% booking fee shall be added. The model shall receive the agreed upon fee, with 20% model agency fee deducted. The total agency fee (booking fee and model agency fee) shall therefor be 35%.<br><br>

Example: Proposed fee for the client is 1.000 euros. Booking fee of 15% is added (1.150 euros). For the model, 20% is subtracted from the fee, totalling 800 euros. Total agency fee is therefor 350 euros. <br><br>

6. The contract between the model / actor and Borderfield BVBA is governed by Belgian law and, in the case of a dispute, only the courts of Antwerp are authorised.
